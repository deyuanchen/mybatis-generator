 ...
 * version: 1.0
 */
public class MyCommentGenerator extends CommentGenerator {
    /**
     * properties配置文件
     */
     ...
     * properties配置文件
     */
    private Properties systemPro;        /*     * 父类时间     */
    ...
    /**
     * *@Title addConfigurationProperties 	 *@Description: 从该配置中的任何属性添加此实例的属性CommentGenerator配置。	 *
     * 这个方法将在任何其他方法之前被调用。
     */
    @Override
    ...
    /**
     * *@Title addJavadocTag      *@Description: 此方法为其添加了自定义javadoc标签。
     */
    @Override
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine("* Copyright(C) 2017-2020 陈德元");
